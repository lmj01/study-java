...
public class FFmpeg4 {
	/**
	    ...
	    */
	    ...
	    public void readImageFromVideo(String videoPath) throws Exception {
	        ...
	        ret = avformat_open_input(fmt_ctx, videoPath, null, null);
	        if (ret < 0) {
	        ...
	        av_dump_format(fmt_ctx, 0, videoPath, 0);
